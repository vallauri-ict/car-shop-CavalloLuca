...
namespace carShopDllProject
{
    ...
    public abstract class Veicolo
    {
        ...
        public Veicolo(string marca, string modello, string colore, int cilindrata, double potenzaKw, DateTime immatricolazione, bool isUsato, bool isKmZero, double prezzo, int kmPercorsi)
        {
            this.Marca = marca;
